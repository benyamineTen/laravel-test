 ...
 <form id="myForm" method="post" action="{{ route('update.client') }}"   >
           ...
           <div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
	 	<select name="statut" class="form-select mb-3" aria-label="Default select example">
			 <option selected=""   >{{ $client->statut }}</option>
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Contact Whatsapp</h6>
				</div>
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="contact_whatsapp" class="form-control" value="{{ $client->contact_whatsapp}}"   />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="email_adress" class="form-control"  value="{{ $client->email_adress }}"  />
				</div>
			</div>
